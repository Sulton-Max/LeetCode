...
namespace Tester
{
    ...
    internal class Program
    {
        ...
        {
            var solution = new String_Ops.LongSubstrWithRep_3.Solution3();
            //var result = solution.LengthOfLongestSubstring("au");
            var result = solution.LengthOfLongestSubstring("abcabcbbghbfchvghdvcgvcfhvgfcghbjnknhgfdresxdcfvghnj");
            //var result = solution.LengthOfLongestSubstring("abcdefda");
...
//    new CustomRegex{Text = "aasdfasdfasdfasdfas", Pattern = "aasdf.*asdf.*asdf.*asdf.*s" }, // True  
//    new CustomRegex{Text = "ab", Pattern = ".*.." }, // True  
//    new CustomRegex{Text = "abbbcd", Pattern = "ab*bbbcd" }, // True  
//};
